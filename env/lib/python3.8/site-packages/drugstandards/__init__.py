...
drugdict = pickle.load(open(dictionary_file, "rb"),encoding="latin1") #MODIFICADA
...
def add_drug_mapping(mapdict):
    ...
    print("Drug dictionary successfully updated...")#MODIFICADA
...
def standardize(druglist, thresh=0.90):
    ...
    for drug in druglist:
        ...
        if gen:
            ...
            if close_match == None: #MODIFICADA
                close_match = drug #MODIFICADA
